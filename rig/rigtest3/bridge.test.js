...
import { parseBridgeMessage, zedToCam } from './js/input/zed-client.js';
import { camToWorld, rotMatrix, matVec3, transpose3 } from './js/input/stereo.js';
import * as ZP from './js/rig/zed-place.js';
import * as RT from './js/rig/rigtest2.js';
import { rigCamera, projectToMonitor, reflectPoint, planeOf, lineDist, sub, dist } from './js/rig/geometry.js';
import { boneTransform, BONES, scaleAboutLens, validHandTune } from './js/rig/hands.js';
...
test('a setup saved by the page as it shipped comes back as the rig as built, not as the old guesses', async () => {
  const RT = await import('./js/rig/rigtest2.js');
